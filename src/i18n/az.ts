...
export const az = {
  ...
  games: {
    kicker: 'Oyunlar',
    title: 'Nə sürəcəksən',
    lead: 'Arcade yoxsa simulyator? Axtardığınız bütün oyunlar bir məkanda. Seçim isə sənindir.',
  ...
  pricing: {
    ...
    title: 'Sadə hesab',
    perHour: '1 saat',
    includesTitle: 'Premium xidmətə standart qiymət',
    include1: 'Professional simracing stendi',
    include2: 'Daim yenilənən sükan dəsti və keyfiyyətli avadanlıq',
    include3: 'Geniş oyun seçimi',
    include4: 'Özəl avtomobil modları',
